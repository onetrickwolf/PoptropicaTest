package net.richardlord.asteroids.components
{
	public class MotionControls
	{
		...
		public var rotateToMouse : Boolean = false;
		
		public function MotionControls( left : uint, right : uint, accelerate : uint, accelerationRate : Number, rotationRate : Number, rotateToMouse : Boolean )
		{
			this.left = left;
			this.right = right;

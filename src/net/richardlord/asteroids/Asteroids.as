package net.richardlord.asteroids
{
	...
	public class Asteroids
	{
		...
		private function prepare( width : Number, height : Number ) : void
		{
			...
			engine.addSystem( new MotionControlSystem( keyPoll, mousePoll ), SystemPriorities.update );
			engine.addSystem( new GunControlSystem( keyPoll, creator ), SystemPriorities.update );
			engine.addSystem( new BulletAgeSystem( creator ), SystemPriorities.update );
			engine.addSystem( new DeathThroesSystem( creator ), SystemPriorities.update );
			engine.addSystem( new MovementSystem( config, mousePoll, creator ), SystemPriorities.move );
